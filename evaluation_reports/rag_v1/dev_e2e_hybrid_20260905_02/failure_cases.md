...
- 自动分：80.0
- 标记：invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
...
- 自动分：50.0
- 标记：missing_answer_points, invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
...
- 标记：missing_answer_points, invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
- 返回实验：exp30, exp30, exp29, exp38, exp46, exp19, exp45, exp44, exp24, exp3, exp35, exp18_b
- 返回资料等级：primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary
...
- split/suite/category：dev / representative / formula
- 自动分：78.75
- 标记：missing_answer_points, invalid_citation
- 首个正确实验排名：1
...
- 标记：missing_answer_points, invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
- 返回实验：exp39, exp39, exp9, exp44, exp25, exp29, exp29, exp12, exp41, exp13, exp23, exp23
- 返回资料等级：primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary
...
- 标记：invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
- 返回实验：exp20, exp20, exp25, exp33, exp25, exp38, exp33, exp18_a, exp18_a, exp34, exp9, exp37
- 返回资料等级：primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary, primary
...
- 自动分：57.5
- 标记：missing_answer_points, boundary_failure, invalid_citation
- 首个正确实验排名：1
...
- split/suite/category：dev / deep / requirements
- 自动分：37.0
- 标记：missing_answer_points, forbidden_claim, invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
...
- split/suite/category：dev / boundary / unanswerable
- 自动分：40.0
- 标记：missing_answer_points, boundary_failure, invalid_citation, citation_wrong_experiment
- 首个正确实验排名：1
