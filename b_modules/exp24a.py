...
def schema():
    """本实验唯一的前端输入结构与示例数据来源。"""
    return make_schema(
        "密立根油滴电量与电荷数线性回归分析的数据输入与处理。",
        [make_table("table1", "密立根油滴电量与电荷数线性回归分析数据", ["q/E-18 c","n"],
                    sample=[["2.098","13"],["2.532","16"],["2.463","15"],["3.712","23"],["6.984","44"],["7.607","47"],["5.702","36"],["2.367","15"],["4.413","28"]])],
